...
#    	print FIIConstants.DIRS.GOOGLE_PLUS_DIR
    	...
    	kloutEmail = configValues.get("KLOUT_EMAIL")
    	kloutPassword = configValues.get("KLOUT_PASSWORD")
    	...
    	if kloutEmail is not None:
    		FIIConstants.Credentials.KLout.EMAIL = base64.decodestring(kloutEmail)
    	if kloutPassword is not None:
    		FIIConstants.Credentials.KLout.PASSWORD = base64.decodestring(kloutPassword)
