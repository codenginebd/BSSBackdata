...
#			print emailField
	...
	def CheckIfPasswordElementExistsInFacebook(self):
		return self.FindElementById("pass")
	
	def CheckIfPasswordElementExistsInLinkedIn(self):
		return self.FindElementById("session_password-login")
	
	def CheckIfTwitterPasswordElementExists(self):
		return self.FindElementByClassName(".js-password-field")
	
	def CheckIfPasswordElementExistsInGoogle(self):
		return self.FindElementById("Passwd")
	
	def CheckIfPasswordElementExistsInKLout(self):
		return self.FindElementById("password")
	
	def CheckIfConnectButtonExistOnKLout(self):
		return self.FindElementByClassName(".tw-connect button")
